<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorRegistrationPage.aspx.cs" Inherits="DoctorRegistrationPage" %>
                ...
                <div class="h-100 d-flex flex-column justify-content-center p-5">
                    ...
                    <form runat="server">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-15">
                                <asp:TextBox ID="TextBox1" runat="server" class="form-control border-0" placeholder="Last Name"></asp:TextBox>
                            </div>
                            ...
                            <div class="col-sm-15">
                                <asp:TextBox ID="txtU_Phone" runat="server" class="form-control border-0" placeholder="National ID"></asp:TextBox>
                            </div>
                             <div class="col-sm-15">
     <asp:TextBox ID="TextBox2" runat="server" class="form-control border-0" placeholder="Phone Number"></asp:TextBox>
 </div>
                             <div class="col-sm-15">
     <asp:TextBox ID="TextBox3" runat="server" class="form-control border-0" placeholder="Experience"></asp:TextBox>
 </div>
