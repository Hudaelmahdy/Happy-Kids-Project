                            ...
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <h1 class="mb-4" style="margin-left: 82px; text-align: center;">Register your child's data</h1>
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-15">
                                            <asp:TextBox ID="txtK_ID" runat="server" class="form-control border-0" placeholder="Child ID" Style="display: none;"></asp:TextBox>
                                        </div>

                                        <div class="col-sm-15">
                                            <asp:TextBox ID="txtKName" runat="server" class="form-control border-0" placeholder="Child Name"></asp:TextBox>
                                        </div>

                                        <div class="col-sm-15">
                                            <asp:TextBox ID="txtK_DOB" runat="server" TextMode="Date" class="form-control border-0" placeholder="Date Of Birth"></asp:TextBox>
                                        </div>

                                        <div class="col-sm-15">
                                            <asp:TextBox ID="txtKGender" runat="server" class="form-control border-0" placeholder="Child Gender"></asp:TextBox>
                                        </div>

                                        <div class="col-sm-15">
                                            <asp:TextBox ID="txtK_Address" runat="server" class="form-control border-0" placeholder="Child Address"></asp:TextBox>
                                        </div>

                                        <div class="col-sm-15">
                                            <asp:TextBox ID="txtK_medcond" runat="server" class="form-control border-0" placeholder="Medical Conditions"></asp:TextBox>
                                        </div>

                                        <div class="col-sm-15">
                                            <asp:TextBox ID="txtK_Chiefcom" runat="server" class="form-control border-0" placeholder="Chief Complaint"></asp:TextBox>
                                        </div>
